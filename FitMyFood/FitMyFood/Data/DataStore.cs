...
namespace FitMyFood.Data
{
    public class DataStore
    {
        ...
        {
            SQLiteAsyncConnection connection = new SQLiteAsyncConnection(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "FitMyFoodSQLite.db3"));
